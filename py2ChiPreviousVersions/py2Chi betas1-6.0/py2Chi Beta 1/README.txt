...
---------------------
 A. Running the Program
   1. Run cooresponding py2Chi by double clicking py2Chi.exe. py2Chi32 for a 32 bit machine and py2Chi64 for a 64 bit machine
   2. Select the pml file or files you would like to convert
